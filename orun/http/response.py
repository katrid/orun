...
from orun.core import signals, signing
from orun.core.exceptions import DisallowedRedirect
from orun.core.serializers.json import OrunJSONEncoder
from orun.http.cookie import SimpleCookie
from orun.utils import timezone
from orun.utils.datastructures import (
    CaseInsensitiveMapping, _destruct_iterable_mapping_values,
)
from orun.utils.encoding import iri_to_uri
from orun.utils.http import http_date
...
class JsonResponse(HttpResponse):
    ...
    :param encoder: Should be a json encoder class. Defaults to
      ``orun.core.serializers.json.OrunJSONEncoder``.
    :param safe: Controls if only ``dict`` objects may be serialized. Defaults
      to ``True``.
    :param json_dumps_params: A dictionary of kwargs passed to json.dumps().
    """

    def __init__(self, data, encoder=OrunJSONEncoder, safe=True,
