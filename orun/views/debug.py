...
# Minimal Orun templates engine to render the error templates
# regardless of the project's TEMPLATES setting. Templates are
# read directly from the filesystem so that the error handler
# works even if the template loader is broken.
DEBUG_ENGINE = Engine(
    debug=True,
    libraries={'i18n': 'orun.templatetags.i18n'},
)
    ...
    def get_traceback_frames(self):
        ...
        while tb is not None:
            ...
            frames.append({
                ...
                'tb': tb,
                'type': 'orun' if module_name.startswith('orun.') else 'user',
                'filename': filename,
                'function': function,
                'lineno': lineno + 1,
