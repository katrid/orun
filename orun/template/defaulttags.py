...
from orun.utils.html import conditional_escape, format_html
from orun.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from orun.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from orun.urls import reverse, NoReverseMatch
...
def load(parser, token):
    ...
    ``orun/templatetags/news/photos.py``::
