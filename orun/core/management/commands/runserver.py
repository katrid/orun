...
from orun.core.servers.basehttp import (
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help='Tells Orun to use an IPv6 address.',
        )
        parser.add_argument(
            '--nothreading', action='store_false', dest='use_threading',
            help='Tells Orun to NOT use threading.',
        )
        parser.add_argument(
            '--noreload', action='store_false', dest='use_reloader',
            help='Tells Orun to NOT use the auto-reloader.',
        )
    ...
    def execute(self, *args, **options):
        if options['no_color']:
            ...
            os.environ["ORUN_COLORS"] = "nocolor"
