...
from orun.db import DEFAULT_DB_ALIAS, connections, migrations
from orun.db.migrations.loader import AmbiguityError, MigrationLoader
from orun.db.migrations.migration import SwappableTuple
        ...
        for smigration in migrations_to_squash:
            if smigration.replaces:
                raise CommandError(
                    ...
                    "https://docs.orunproject.com/en/%s/topics/migrations/#squashing-migrations" % get_docs_version()
                )
