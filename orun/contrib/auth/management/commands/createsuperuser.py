...
from orun.contrib.auth.management import get_default_username
from orun.contrib.auth.password_validation import validate_password
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                'Tells Orun to NOT prompt the user for input of any kind. '
