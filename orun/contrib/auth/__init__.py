...
from orun.apps import apps as orun_apps
from orun.conf import settings
from orun.core.exceptions import ImproperlyConfigured, PermissionDenied
from orun.middleware.csrf import rotate_token
from orun.utils.crypto import constant_time_compare
from orun.utils.module_loading import import_string
from orun.utils.translation import LANGUAGE_SESSION_KEY
...
def logout(request):
    ...
    if hasattr(request, 'user'):
        from orun.contrib.auth.models import AnonymousUser
