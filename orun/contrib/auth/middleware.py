...
from orun.contrib.auth.backends import RemoteUserBackend
    ...
    def process_request(self, request):
        ...
        if not hasattr(request, 'user'):
            raise ImproperlyConfigured(
                "The Orun remote user auth middleware requires the"
...
class PersistentRemoteUserMiddleware(RemoteUserMiddleware):
    ...
    the application wants to use Orun's authentication mechanism.
    """
