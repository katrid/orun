...
class GenericForeignKey(BaseField, FieldCacheMixin):
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        ...
        # TODO fix add field into add_field on Options
    ...
    def _check_content_type_field(self):
        ...
        try:
            ...
            elif field.remote_field.model.Meta.inherits != ContentType:
                return [
                    checks.Error(
...
class GenericRelation(ForeignObject):
    ...
    def get_content_type(self):
        ...
        """
        return apps[ContentType].objects.get_for_model(
            self.model,
...
def create_generic_related_manager(superclass, rel):
    ...
    class GenericRelatedObjectManager(superclass):
        def __init__(self, instance=None):
            ...
            content_type = apps[ContentType].objects.db_manager(instance._state.db).get_for_model(
