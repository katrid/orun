...
from orun.contrib.staticfiles.utils import check_settings, matches_patterns
from orun.core.cache import (
    InvalidCacheBackendError, cache as default_cache, caches,
)
from orun.core.exceptions import ImproperlyConfigured
from orun.core.files.base import ContentFile
from orun.core.files.storage import FileSystemStorage, get_storage_class
from orun.utils.deprecation import RemovedInOrun31Warning
from orun.utils.functional import LazyObject
...
class CachedStaticFilesStorage(CachedFilesMixin, StaticFilesStorage):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            ...
            RemovedInOrun31Warning, stacklevel=2,
        )
        super().__init__(*args, **kwargs)
