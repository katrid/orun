...
var oui = (() => {
  ...
  __export(index_exports, {
    actions: () => homepage_exports,
    controls: () => menu_exports,
    dialogs: () => dialogs_exports,
    grids: () => table_utils_exports,
    portlets: () => all_exports
  });
  ...
  var HomepageView = class extends BaseWidget {
    ...
    addNewPortlet(portletClass, colIndex) {
      ...
      console.debug("add to ", this.columns.length, colIndex, col.element);
  ...
  var ModalResult = /* @__PURE__ */ ((ModalResult2) => {
    ModalResult2["OK"] = "ok";
    ModalResult2["CANCEL"] = "cancel";
    ModalResult2["YES"] = "yes";
    ModalResult2["NO"] = "no";
    ModalResult2["NONE"] = "none";
    return ModalResult2;
  })(ModalResult || {});
  var modalResultText = {
    ["ok" /* OK */]: "OK",
