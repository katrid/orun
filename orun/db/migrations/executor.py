...
class MigrationExecutor(object):
    ...
    def migrate(self, targets, plan=None, fake=False, fake_initial=False):
        ...
        Orun first needs to create all project states before a migration is
        (un)applied and in a second step run all the database operations.
        """
        if plan is None:
            plan = self.migration_plan(targets)
        # Create the forwards plan Orun would follow on an empty database
    ...
    def _migrate_all_backwards(self, plan, full_plan, fake):
        ...
        migration, Orun will compute the migration states before each of them
