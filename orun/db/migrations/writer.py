...
from orun.utils.timezone import now, utc
...
class MigrationWriter(object):
    ...
    def basedir(self):
        ...
        if migrations_package_name is None:
            raise ValueError(
                "Orun can't create migrations for app '%s' because "
    ...
    def serialize(cls, value):
        ...
        # Settings references
            ...
            return "settings.%s" % value.setting_name, {"from orun.conf import settings"}
        # Simple types
        ...
        # Uh oh.
            ...
            raise ValueError(
                ...
                "migration files.\nFor more, see https://docs.orunproject.com/en/%s/"
