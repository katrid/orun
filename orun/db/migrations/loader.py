...
from orun.db.migrations.recorder import MigrationRecorder
...
class MigrationLoader(object):
    ...
    inherit from orun.db.migrations.Migration. See
    orun.db.migrations.migration for what that looks like.
    ...
    @classmethod
    def migrations_module(cls, addon_name):
        ...
        for app_config in app.addons:
            ...
            try:
                ...
                if "No module named" in str(e) and MIGRATIONS_MODULE_NAME in str(e):
                    self.unmigrated_apps.add(app_config.schema)
                    continue
                raise
            else:
            ...
            for migration_name in migration_names:
                ...
                self.disk_migrations[app_config.schema, migration_name] = migration_module.Migration(
                    migration_name,
                    app_config.schema,
                )
            ...
            if missing in reverse_replacements:
                ...
                if not is_replaced:
                    ...
                    exc_value = NodeNotFoundError(
                        ...
                        "Orun tried to replace migration {1}.{2} with any of [{3}] "
