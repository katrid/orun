...
/"""
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the Orun convention of using
    ...
    def fetch_returned_insert_id(self, cursor):
        try:
            ...
            raise DatabaseError(
                ...
                'Oracle OCI library (see https://code.orunproject.com/ticket/28859).'
            )
    ...
    def sql_flush(self, style, tables, sequences, allow_cascade=False):
        if tables:
            ...
            # foreign keys which Orun doesn't define. Emulate the
    ...
    def compiler_module(self):
        ...
        return 'orun.db.backends.oracle.compiler'
