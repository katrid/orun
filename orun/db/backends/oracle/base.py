...
def wrap_oracle_errors():
    try:
        ...
        #            'ORA-02291: integrity constraint (TEST_ORUNTEST.SYS
        #               _C00102056) violated - parent key not found'
        #            or:
        #            'ORA-00001: unique constraint (ORUNTEST.DEFERRABLE_
        #               PINK_CONSTRAINT) violated
        # Convert that case to Orun's IntegrityError exception.
        x = e.args[0]
        if (
                hasattr(x, 'code') and
...
class FormatStylePlaceholderCursor:
    """
    Orun uses "format" (e.g. '%s') style placeholders, but Oracle uses ":var"
