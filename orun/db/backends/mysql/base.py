"""
MySQL database backend for Orun.
...
# terms of actual behavior as they are signed and include days -- and Orun
# expects time.
orun_conversions = {
    **conversions,
...
class CursorWrapper:
    ...
    def execute(self, query, args=None):
        try:
            ...
            # misclassified and Orun would prefer the more logical place.
