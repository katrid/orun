"""
Dummy database backend for Orun.

Orun uses this if the database ENGINE setting is empty (None or empty string).
...
from orun.db.backends.base.introspection import BaseDatabaseIntrospection
from orun.db.backends.base.operations import BaseDatabaseOperations
from orun.db.backends.dummy.features import DummyDatabaseFeatures
