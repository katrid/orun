...
from orun.db import DEFAULT_DB_ALIAS, NotSupportedError, connections
from orun.db.models.aggregates import Count
from orun.db.models.constants import LOOKUP_SEP
from orun.db.models.expressions import Col, F, Ref, SimpleCol
from orun.db.models.fields import Field
from orun.db.models.fields.related_lookups import MultiColSource
from orun.db.models.lookups import Lookup
from orun.db.models.query_utils import (
    Q, check_rel_lookup_compatibility, refs_expression,
)
from orun.db.models.sql.constants import (
    INNER, LOUTER, ORDER_DIR, ORDER_PATTERN, SINGLE,
)
from orun.db.models.sql.datastructures import (
    BaseTable, Empty, Join, MultiJoin,
)
from orun.db.models.sql.where import (
    AND, OR, ExtraWhere, NothingNode, WhereNode,
)
from orun.utils.functional import cached_property
from orun.utils.tree import Node
...
def get_field_names_from_opts(opts):
    return set(chain.from_iterable(
        ...
        for f in opts.get_fields() if f.selectable
    ))
...
class Query:
    ...
    def rewrite_cols(self, annotation, col_cnt):
        ...
        # If we are aggregating over an annotation, then Orun uses Ref()
    ...
    def get_aggregation(self, using, added_aggregate_names):
        ...
        if (isinstance(self.group_by, tuple) or has_limit or has_existing_annotations or
            ...
            from orun.db.models.sql.subqueries import AggregateQuery
    ...
    def is_nullable(self, field):
        ...
        Some backends treat '' as null and Orun treats such fields as
    ...
    def __reduce__(self):
        return query_unpickle, (self.model._meta.name,), self.__getstate__()
...
def query_unpickle(model_id):
    """Used to unpickle Model subclasses with deferred fields."""
    return Query(apps[model_id])
