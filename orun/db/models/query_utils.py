...
Factored out from orun.db.models.query to avoid making the main module very
...
class PropertyDescriptor(FieldCacheMixin):
    ...
    def __get__(self, instance, owner):
        ...
        try:
            ...
            if isinstance(self.getter, str):
                self.getter = getattr(owner, self.getter)
    ...
    def __set__(self, instance, value):
        ...
        if isinstance(setter, str):
            setter = getattr(instance.__class__, setter)
        if setter:
