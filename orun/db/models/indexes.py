...
from orun.db.models.expressions import Col, ExpressionList, F, Func, OrderBy
from orun.db.models.functions import Collate
from orun.db.models.query_utils import Q
from orun.db.models.sql import Query
from orun.utils.functional import partition
...
class Index:
    ...
    def deconstruct(self):
        ...
        path = path.replace('orun.db.models.indexes', 'orun.db.models')
