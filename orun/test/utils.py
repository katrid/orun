...
from orun.core.signals import request_started
from orun.db import DEFAULT_DB_ALIAS, connections, reset_queries
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = 'orun.core.mail.backends.locmem.EmailBackend'
