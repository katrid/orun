...
from orun.core.exceptions import ImproperlyConfigured, ValidationError
from orun.core.files import locks
from orun.core.handlers.wsgi import WSGIHandler, get_path_info
from orun.core.management import call_command
from orun.core.management.color import no_style
from orun.core.management.sql import emit_post_migrate_signal
from orun.core.servers.basehttp import ThreadedWSGIServer, WSGIRequestHandler
from orun.db import DEFAULT_DB_ALIAS, connection, connections, transaction
from orun.forms.fields import CharField
from orun.http import QueryDict
from orun.http.request import split_domain_port, validate_host
from orun.test.client import Client
from orun.test.html import HTMLParseError, parse_html
from orun.test.signals import setting_changed, template_rendered
from orun.test.utils import (
    CaptureQueriesContext, ContextList, compare_xml, modify_settings,
    override_settings,
)
from orun.utils.decorators import classproperty
...
class _SimpleTestCaseDatabasesDescriptor:
    ...
    def __get__(self, instance, cls=None):
        try:
            ...
            warnings.warn(msg, RemovedInOrun31Warning)
...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common Orun test
    ...
    def assertRedirects(self, response, expected_url, status_code=302,
        ...
        if hasattr(response, 'redirect_chain'):
            ...
            if fetch_redirect_response:
                # netloc might be empty, or in cases where Orun tests the
                ...
                if domain and not validate_host(domain, settings.ALLOWED_HOSTS):
                    raise ValueError(
                        ...
                        "If the host is served by Orun, add '%s' to ALLOWED_HOSTS. "
    ...
    def _assert_template_used(self, response, template_name, msg_prefix):
        ...
        if template_name is not None and response is not None and not hasattr(response, 'templates'):
            raise ValueError(
                ...
                "usable on responses fetched using the Orun test Client."
            )
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, Orun will serialize the database
...
class FSFilesHandler(WSGIHandler):
    ...
    def serve(self, request):
        ...
        # Emulate behavior of orun.contrib.staticfiles.views.serve() when it
