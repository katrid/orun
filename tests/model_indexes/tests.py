...
from orun.db.models.functions import Lower, Upper
from orun.test import SimpleTestCase, TestCase, skipUnlessDBFeature
from orun.test.utils import isolate_apps
...
class SimpleIndexesTests(SimpleTestCase):
    ...
    def test_expressions_with_opclasses(self):
        msg = (
            ...
            'orun.contrib.postgres.indexes.OpClass() instead.'
        )
        with self.assertRaisesMessage(ValueError, msg):
            models.Index(
                Lower('field'),
    ...
    def test_deconstruction(self):
        ...
        self.assertEqual(path, 'orun.db.models.Index')
    ...
    def test_abstract_children(self):
        ...
        self.assertEqual(
            index_names,
            ['model_index_name_bdce9a_idx', 'model_indexes_childmodel1_idx'],
        )
        index_names = [index.name for index in ChildModel2._meta.indexes]
        self.assertEqual(
            index_names,
            ['model_index_name_65cade_idx', 'model_indexes_childmodel2_idx'],
        )
