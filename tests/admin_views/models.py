...
from orun.contrib.contenttypes.fields import (
...
class Link(models.Model):
    ...
    url = models.URLField()
    post = models.ForeignKey("admin_views.post", models.CASCADE)
...
class CyclicOne(models.Model):
    name = models.CharField(max_length=25)
    two = models.ForeignKey('admin_views.cyclic.two', models.CASCADE)
...
class Pizza(models.Model):
    name = models.CharField(max_length=20)
    toppings = models.ManyToManyField('admin_views.topping', related_name='pizzas')
...
class Ingredient(models.Model):
    ...
    recipes = models.ManyToManyField(Recipe, through='admin_views.recipe.ingredient')
...
class Author(models.Model):
    ...
    books = models.OneToManyField('admin_views.authorship')
...
class NestedData(models.Model):
    nested2 = models.OneToManyField('admin_views.nested.data2')
    partner = models.ForeignKey('res.partner')
    author = models.ForeignKey(Author, null=False)


class NestedData2(models.Model):
    nested_data = models.ForeignKey(NestedData, null=False)
    author = models.ForeignKey(Author)
    decimal_field = models.DecimalField()
    int_field = models.IntegerField()
    nested3 = models.OneToManyField('admin_views.nested.data3')


class NestedData3(models.Model):
    nested_data2 = models.ForeignKey(NestedData2, null=False)
    author = models.ForeignKey(Author)
    nested4 = models.OneToManyField('admin_views.nested.data4')


class NestedData4(models.Model):
    nested_data3 = models.ForeignKey(NestedData3, null=False)
    name = models.CharField(100)
    author = models.ForeignKey(Author)
    nested5 = models.OneToManyField('admin_views.nested.data5')


class NestedData5(models.Model):
    nested_data4 = models.ForeignKey(NestedData4, null=False)
    name = models.CharField(100)
    author = models.ForeignKey(Author)
