...
from orun.db import DatabaseError, NotSupportedError, connection
...
from orun.db.models.functions import (
    Coalesce, Concat, Left, Length, Lower, Substr, Upper,
)
from orun.db.models.sql import constants
from orun.db.models.sql.datastructures import Join
from orun.test import SimpleTestCase, TestCase, skipUnlessDBFeature
...
class FTests(SimpleTestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, 'orun.db.models.expressions.F')
...
class ValueTests(TestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, 'orun.db.models.expressions.Value')
